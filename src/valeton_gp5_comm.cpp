...
uint8_t* valeton_gp5_delay_toggle_request(bool on, int& out_size)
{
    uint8_t reqOn[] = { 0x04, 0x09, 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    uint8_t reqOff[] = { 0x04, 0x09, 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

    out_size = on 
        ? valeton_gp5_build_sysex((const uint8_t*)reqOn, sizeof(reqOn), 0x01)
        : valeton_gp5_build_sysex((const uint8_t*)reqOff, sizeof(reqOff), 0x01);
